## 风花雪月移动版
#### 注意
在南+遇到个判官diaodiaohai，居然说在国内分享是违法的，还把我举报了。真恶心。
以前的安装包删了，下次更新3.0.会删除所有隐藏模式入口。正常模式不受影响。
如果只是为了隐藏模式，不建议更新3.0之后的版本。
#### ABOUT
...
- 2.应用内点击设置说明->点击自定义返回功能->将上面网站的名称输入进去，中间用,或者换行符。在首页长按返回键执行。
#### HFHXY 11.6
- 1.更新了NHentei(类似eh)
- 2.增加了漫画下载功能
- 3.实用工具里增加了账号管理功能
